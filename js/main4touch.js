...
var tamWidh = [95,95,95,95,95,95,95,95];
var tamHeight = [95,95,95,95,95,95,95,95];
...
var origX = [81,129,177,225,33,81,129,177];   
var origY = [271,271,271,271,352,352,352,352];

function iman(){
	for(var i=0;i<piezas.length;i++){
		if (Math.abs(currentPosX-origX[i])<9 && Math.abs(currentPosY-origY[i])<9) {
